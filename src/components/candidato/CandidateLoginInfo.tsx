...
export default function CandidateLoginInfo() {
  return (
    <section className="flex flex-col items-center text-center lg:items-start lg:text-left w-[35%]">
...
function LoginFeature({ icon, title, description }: LoginFeatureProps) {
  return (
    <div className="flex min-h-16 items-center gap-4 rounded-xl border border-[#d9d9d9] bg-(--white) p-3!">
